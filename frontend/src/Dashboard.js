 ...
 const baseURL =
  ...
  return (
    <div className="flex flex-col items-center w-full bg-slate-50">
      <div
        className="flex flex-col items-center gap-6 w-full p-6 text-white bg-cover bg-center"
      ...
      >
        ...
        <button
          ...
          className={`px-6 py-3 rounded-md text-xl font-bold transition-all duration-200 ${
            activeSearch
      ...
      <div className="w-full px-4 py-8 grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
        {loading ? (
          <div className="text-center col-span-full text-xl">
            Loading vendors...
          </div>
        ) : (
          filteredAccounts.map((vendor) => {
            ...
            return (
              <div
                key={vendor._id}
                className="relative bg-white rounded-lg shadow-md p-5 space-y-4"
              >
                <div className="flex flex-col items-center">
                  {vendor.profile ? (
                    <img
                      src={`data:image/jpeg;base64,${vendor.profile}`}
                      alt="Profile"
                  ...
                  <a href={vendor.instagramLink} className="text-blue-500">
                    @{vendor.instagramHandle}
                  </a>
                  <div className="text-sm">
                    {isVerified ? (
                      <img src={Verify} className="w-5 inline ml-2" />
                    ) : (
                  ...
                  <div className="mt-4 text-sm text-gray-700 space-y-1">
                    ...
                    <p>
                      <strong>✍</strong> {vendor.businessName}
                    </p>
                    <p>
                      <strong>🏠</strong> {vendor.shopAddress}
                    </p>
                    <p>
                      <strong>📧</strong> {vendor.email}
                    </p>
                    <p>
                  ...
                  <button
                    onClick={() =>
                      setDisplayProductId(
                        displayProductId === vendor._id ? null : vendor._id
                      )
                    }
                  ...
                  {displayProductId === vendor._id && (
                    <div className="absolute inset-0 bg-white/95 p-4 rounded-lg shadow-lg z-50 flex flex-col items-end">
                      <span
                        onClick={() => setDisplayProductId(null)}
                      ...
                      {vendor.productImage ? (
                        <img
                          src={`data:image/png;base64,${vendor.productImage}`}
                          alt="Product"
