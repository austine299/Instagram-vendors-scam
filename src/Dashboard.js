  ...
  return (
    <div className="flex flex-col items-center w-full p-4 gap-8 bg-slate-50">
      ...
      <div className="flex flex-col sm:flex-row gap-6 items-center justify-center w-full  sm:w-1/2">
        <button className="border-2 bg-white px-3 py-1 rounded-md w-10/12 hover:bg-gray-700 hover:text-white text-xl font-bold">
          Search Vendors
        </button>
        <button className="border-2 bg-blue-700 px-3 py-1 rounded-md w-10/12 hover:bg-blue-500 text-white text-xl font-bold">
          Verify My Business
        </button>
      </div>
      <div className=" flex flex-col sm:flex-row gap-5 justify-around items-center bg-white w-full  py-6 ">
        <div className="flex flex-col items-start text-center w-2/3  sm:w-1/5">
        ...
        <div className="flex flex-col items-start text-center w-2/3  sm:w-1/5">
          ...
          <p className="text-center text-2xl font-semibold">
            Vendors sign up and complete KYC verification
          </p>
        </div>
